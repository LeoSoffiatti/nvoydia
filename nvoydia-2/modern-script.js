...
class ModernDigitalNativesPlatform {
    ...
    setupFilterControls() {
        ...
        partnerFilter?.addEventListener('change', (e) => {
            this.filterCompaniesByPartner(e.target.value);
        });
    ...
    filterCompaniesByIndustry(industry) {
        ...
        const allCompanies = this.dataService.companies;
        let filteredCompanies = industry ? 
        ...
        if (partnerFilter && partnerFilter.value) {
            filteredCompanies = this.filterCompaniesByPartnerStatus(filteredCompanies, partnerFilter.value);
        }
